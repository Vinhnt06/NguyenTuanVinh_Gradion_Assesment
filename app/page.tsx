...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-[#0D0D0F] text-[#F2EEE7] selection:bg-[#FF6B00] selection:text-white overflow-hidden font-sans">
      {/* Left Artwork Hero Panel (7 Cols desktop) - Visual Identity */}
      <div className="lg:col-span-7 bg-[#121216] text-white p-8 lg:p-16 flex flex-col justify-between relative overflow-hidden min-h-[500px] lg:min-h-screen border-r border-[#22222B]">
        {/* GPU-Accelerated Static Ambient Orbs */}
        <div className="absolute -top-32 -left-32 w-[520px] h-[520px] bg-[#FF6B00]/15 rounded-full blur-[140px] pointer-events-none transform-gpu" />
        <div className="absolute -bottom-32 -right-32 w-[520px] h-[520px] bg-[#FFA861]/10 rounded-full blur-[140px] pointer-events-none transform-gpu" />
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-3 my-8 lg:my-0">
          <div className="p-3.5 rounded-2xl bg-[#181820]/90 border border-[#272736] hover:border-[#FF6B00]/40 transition-colors flex items-center gap-3 cursor-pointer shadow-sm">
      ...
      {/* Right Form Panel (5 Cols desktop) - Dark Authentication */}
      <div className="lg:col-span-5 flex items-center justify-center p-6 lg:p-12 bg-[#0D0D0F] relative overflow-hidden">
        {/* Subtle Background Glow behind form */}
        <div className="absolute w-72 h-72 bg-[#FF6B00]/10 rounded-full blur-[100px] pointer-events-none transform-gpu" />

        <div className="w-full max-w-[400px] bg-[#141419]/90 backdrop-blur-md rounded-3xl p-8 border border-[#262632] hover:border-[#353545] transition-colors shadow-2xl relative z-10">
          <div className="mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#0D0D0F] border border-[#2D2D3B] rounded-xl text-sm text-white placeholder-[#52525B] focus:outline-none focus:border-[#FF6B00] focus:ring-1 focus:ring-[#FF6B00] transition-colors"
                disabled={loading}
              />
            </div>
